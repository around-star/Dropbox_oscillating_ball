...
from latent_ode_wo_enc import LatentODE
...
def create_LatentODE_model(input_dim, z0_prior, obsrv_std, device, 
    ...
    if poisson:
        ...
        #dim = latents ### OG Code
        latents_new = latent_embedder_out_dim + 512 + vel_dim
        dim = latents_new
        #print("Dim: ", dim)
    ...
    # decoder = Decoder(512, 512).to(device)
    # decoder_pose = Decoder(angle_dim, angle_dim).to(device)
