...
def train():
    ...
    load_dict = torch.load('/home/guests/hiran_sarkar/FullCode/DyNeRF-ODE_latent_dyn_var_position_vel_static_latent/logs_hill_near_new_vel_complete_seq/loc_mlp_latent_node_euler_seperate_cnos_pose_and_vel_90_ts_65_vel_loss_concat_net_8/pitcher_base/165000.tar')#["network_fine_state_dict"]
    ...
    # angles = []
    # for x in torch.linspace(-0.6, 0.56, 20):
    #     for y in torch.linspace(0.067, 1.24, 20):
    ...
    try:
        ...
        tsne_result = pca.fit_transform(total_latents)
    ...
    plt.savefig('pca_hill_near_new_complete_loc_mlp_latent_node_euler_seperate_cnos_pose_and_vel_90_ts_65_vel_loss_concat_net/extrap_12_vel_plot_static_lat.png')
