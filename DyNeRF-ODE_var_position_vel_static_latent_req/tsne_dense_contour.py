...
def train():
    ...
    load_dict = torch.load('/hdd2/hiran/NeRF/DyNeRF-ODE_latent_dyn_var_position_vel_static_latent/logs_bowl_multi_cam/static_lat_200_2D_decoder_1layers_lips_prod_16_seqs_netwidth_512/pitcher_base/660000.tar')#["network_fine_state_dict"]
    ...
    for x in torch.linspace(-0.3, 0.3, 5):
        for y in torch.linspace(0.08, 0.8, 5):
            angles.append([x.item(),y.item()])

    # angles = torch.tensor([[-0.04509001970291138, 1.077239990234375],
    #             [-0.13508999347686768, 0.22724008560180664],
    #             [-0.22509001195430756, 1.0572400093078613],
    #             [-0.295089989900589, 0.26724007725715637],
    #             [-0.3850899934768677, 0.9472400546073914],
    #             [-0.44508999586105347, 0.6472400426864624],
    #             [-0.4550899863243103, 0.44724005460739136],
    #             [-0.4950900077819824, 0.8072400093078613],
    #             [0.05491000413894653, 0.22724008560180664],
    #             [0.17490997910499573, 1.0472400188446045],
    #             [0.24491000175476074, 0.28724008798599243],
    #             [0.27490997314453125, 1.0072399377822876],
    #             [0.3449099659919739, 0.9472399950027466],
    #             [0.39490997791290283, 0.4272400736808777],
    #             [0.4249099791049957, 0.7672399878501892],
    #             [0.4449099898338318, 0.527239978313446],
    #             [0.4549099802970886, 0.5972399711608887],
    #             [0.48490995168685913, 0.6672400236129761],
    #             ])
    ...
    # 0.29651087522506714 - 0.3145599067211151,
    # 0.4808536171913147 - 0.49201053380966187,
    # 0.5105934143066406 - 0.5118327736854553
    ...
    # ax.view_init(elev=90, azim=90)  # Adjust elevation and azimuth angles
    # for i, result in enumerate(tsne_result):
    #     # Skip initial iterations if needed
    #     # if i <= 20:
    #     #     continue
    #     # elif i > 25:
    #     #     break
    ...
    #     ax.plot(result[:, 0], 
    #             result[:, 1], 
    #             result[:, 2],  # Assuming 3D t-SNE result
    #             alpha=0.7)

    #     # Mark the starting point
    #     ax.scatter(result[0, 0], 
    #             result[0, 1], 
    #             result[0, 2],  
    #             color='green', 
    ...
    # ax.set_title("3D t-SNE Trajectories")

    # # Show legend
    # ax.legend(loc='lower left', bbox_to_anchor=(1, 1))
    # plt.savefig("tsne_3d_plot_xy.png", dpi=300, bbox_inches='tight')
    # exit()
    ...
    plt.savefig('oscillating_ball_tsne_70ts.png')
